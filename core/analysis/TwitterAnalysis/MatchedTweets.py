...
def getGluttonyWords():
    """
    :return: gets a list of keywords based on gluttony to match with the corpus
    core/analysis/Resources/gluttony.tx
    """
...
def gluttonyTest(text, gluttony_words):
    """
    check if a test contains gluttony keywords
    :param tweet: tweet object Tweet()
    :param gluttony_words:
    :return:Boolean
    """
...
def getReduceTweets(corpus_tweets):
    """
    filter out tweets that don't show gluttony
    :param corpus_tweets: list of tweets
    :return: tweets that have gluttony in text
    """
